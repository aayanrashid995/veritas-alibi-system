...
- Universal Parser: Handles PowerShell `Format-Table` output, CSV exports, and raw text.  
...
The system extracts five key forensic vectors:  
...
- Training Strategy: Trained on 3,000 synthetic forensic cases including "False Positive" scenarios.  
...
SHAP Analysis: Waterfall plots show exactly why the AI reached its decision (e.g., "+20% confidence due to Login Event").  
...
Before running the app, generate the training data and compile the model.  
```bash
